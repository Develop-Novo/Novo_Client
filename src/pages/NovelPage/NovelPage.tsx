...
function NovelPage() {
  ...
  useEffect(() => {
    ...
    getAllRating().then((res) => {
      ...
      const tmp = filterByMemberId(res.data, 152)[0];
      if (tmp !== undefined) {
        setMyRating(tmp);
      }
    });
          ...
          <div className={styles.container}>
            <div className={styles.novel__info__wrapper}>
              ...
              <div className={styles.novel__contents}>
                <div className={styles.novel__contents__r1}>
                  <StarRating novelId={novel.id} myRating={myRating} />
                  <button className={styles.novel__contents__button__comment}>
                    <div
                      className={styles.novel__contents__button__comment__text}
                    >
                      코멘트 남기기
                    </div>
                  </button>
            ...
            <div className={styles.novel__comment__wrapper}>
              <div className={styles.novel__comment__info}>
                ...
                <span className={styles.novel__comment__count}>100+</span>
